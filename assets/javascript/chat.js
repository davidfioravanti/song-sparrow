...
================================================================= */
    ...
    var messagesRef = database.ref("/messages").child("asd").limitToLast(5);
    ...
    connectedRef.on("value", function(snap) {
        ...
        var date = new Date();
        var timestamp = date.getUTCMonth() + "/" + date.getUTCDay() + "/" + date.getUTCFullYear() +
    ...
    database.ref("/messages").limitToLast(10).on("child_added", function(childSnap) {
        ...
        var newMessage = $("<div class='row messageDiv'>" +
        "<span class='col-12 messageUsername'>" + Username + " : " + 
